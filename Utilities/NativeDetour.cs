...
internal static class NativeDetour
{
    ...
    /// <summary>
    /// NOVA sobrecarga: resolve AmbiguousMatchException usando parâmetros.
    /// </summary>
    public static INativeDetour Create<T>(Type type, string methodName, Type[] paramTypes, T to, out T original) where T : Delegate
    {
        return Create(type.GetMethod(methodName, AccessTools.all, null, paramTypes, null), to, out original);
    }
